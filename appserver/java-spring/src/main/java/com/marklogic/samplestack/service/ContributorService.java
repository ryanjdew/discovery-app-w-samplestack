...
/**
 * Defines methods for interacting with the corpus of Contributor objects. This
 * interface hides and decorates methods from the POJORepository.
 */
public interface ContributorService {
	...
	/**
	 * Search for a generic string, based on stored query options for
	 * contributors
	 * 
	 * @param q
	 *            the query string
	...
	/**
	 * A wrapper around write, this method provides cardinality protection upon
	 * insert for userName
	 */
	 ...
	 * @param contributor
	 * @param transaction
	 *            transaction in which to store the contributor.
	 */
	...
	/**
	 * Wraps PojoRepository.read. Unlike PojoRepository.read, this method
	 ...
	 * 
	 * @param start
	 *            The first index of the readAll operation
	 * @return A Page of Contributor objects.
	 */
	public PojoPage<Contributor> readAll(int start);

	/**
	 * Reads an object by ID within a transaction. Ensures that votes and
	 * reputation updates can happen in the same atomic unit.
	 * 
	 * @param toAdjustId
	 *            id of contributor object to adjust.
	 * @param transaction
	 *            the transaction in which to evaluate this read.
